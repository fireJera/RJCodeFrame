...
#import "UIScreen+JER_Custom.h"

@implementation UIScreen (JER_Custom)
...
- (CGRect)currentBounds {
    return [self boundsForOrentation:[[UIApplication sharedApplication] statusBarOrientation]];
}

- (CGRect)boundsForOrentation:(UIInterfaceOrientation)oriertation {
    CGRect bounds = [self bounds];
    if (UIInterfaceOrientationIsLandscape(oriertation)) {
